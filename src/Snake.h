...
enum mode{beforeGame,helpBeforeGame,settings,settingsPosition,settingsSize,settingsColor,game,afterGame,help,pause};
...
class Snake {
    ...
    public:
        ...
        bool handleEventDuringSettingsColorMode(int key);
